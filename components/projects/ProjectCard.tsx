...
export default function ProjectCard({
  ...
  return (
    <motion.div
      ...
      aria-hidden="true"
      className="relative grid lg:h-[550px] p-[2px] w-full overflow-hidden rounded-3xl rounded-md bg-zinc-200 dark:bg-zinc-900">
      <div className="glow inset-0 w-[200px] h-[200px] absolute rotate-45"></div>
        <div className="inline-block h-[100%] bg-zinc-200 dark:bg-zinc-800 rounded-md w-[100%] z-10 relative">
        <motion.div
          ref={ref}
          animate={ctrls}
          initial="hidden"
        ...
        >
          <Image
            ...
            src={image}
            alt={title}
            className="relative lg:absolute bottom-0 right-0 w-[95%] lg:w-[85%] object-contain md:w-[60%] lg:max-w-[55%]"
          />
        </motion.div>
        </div>
      </motion.div>
